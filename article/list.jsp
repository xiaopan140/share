...
<html>
  ...
  <div class="main">
位置：<a href="channel.do?id=${fatherId }">${fatherName}</a>>>${channelName}
...
<TABLE class="gridtable" width="100%">
	...
	<TR>
		...
		<TD><a href="article_view.do?id=${id}&channelId=${channelId}&fatherId=${fatherId}"><s:property value="title"/></a></TD>
		<TD width="80"><s:property value="createTime"/></TD>
...
<TABLE border="0" width="100%" class="pager">
	<TR>
	<form action="article_list.do?channelId=${channelId}&fatherId=${fatherId}" method="post" name="form1">
		<TD>
